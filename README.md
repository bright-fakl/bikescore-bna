...
`bikescore` targets value-for-value parity with brokenspoke-analyzer. Each stage output is
...
`bikescore.deviations`; see the docs under **Differences from brokenspoke-analyzer**. Where
