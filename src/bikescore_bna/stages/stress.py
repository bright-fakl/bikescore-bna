...
def _apply_intersection_rules(
    ...
    """
    from bikescore_bna.decision import run_decision
    from bikescore_bna.rules.providers import INTERSECTION_CATALOG
...
from bikescore_bna.stage import StageSpec, build_rule_variables  # noqa: E402
