"""bikescore-bna — single-city bicycle network analysis as a database-free library.
...
This package must never import from the orchestration layer (``bikescore``);
...
from bikescore_bna.acquire import InputProvider, acquire_city, discover_inputs
from bikescore_bna.city import CityIdentity, load_city
...
from bikescore_bna.pipeline import PIPELINE, ScoreResult, score_city
from bikescore_bna.scenarios import get_bundled_scenario, list_bundled_scenarios
