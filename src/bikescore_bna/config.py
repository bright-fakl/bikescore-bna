...
class BNAConfig:
    ...
    project_root: Path = field(default_factory=lambda: Path.home() / ".bikescore-bna" / "projects")
    ...
    def validate(self, *, runtime: bool = False) -> None:
        ...
        if self.intersection_attributes is not None:
            from bikescore_bna.intersection_attributes import STRESS_REQUIRED_ATTRIBUTES
        ...
        if self.attributes is not None:
            ...
            from bikescore_bna.decision.analysis.variables import undeclared_variables
    ...
    def with_defaults(cls, **kwargs: object) -> BNAConfig:
        ...
        """
        from bikescore_bna.attributes import AttributeRegistry, load_builtin_attributes
        from bikescore_bna.destinations import default_destination_registry
