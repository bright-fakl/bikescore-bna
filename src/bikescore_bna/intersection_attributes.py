...
``name`` plus a row-level :class:`~bikescore_bna.decision.Matcher` (the same
...
from bikescore_bna.decision import Matcher
from bikescore_bna.destinations import _row, matcher
...
def _clause_to_terse(clause: Any) -> tuple[str, Any]:
    ...
    Inverse of :func:`bikescore_bna.destinations._clause_from_cond`:
