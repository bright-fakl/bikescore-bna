...
def get_intersection_context(
    ...
    """
    from bikescore.rules.providers import _CROSSING_ALL, _crossing_high_stress_vec
...
def resolve_osm_id_from_road_id(road_id: int, results: dict[str, Any]) -> int | None:
    ...
    """
    from bikescore.stages.segment import SegmentResult
...
def trace_way(way_id: int, results: dict[str, Any]) -> list[StageTrace]:
    ...
    """
    from bikescore.stages.segment import SegmentResult  # local to avoid circular import
